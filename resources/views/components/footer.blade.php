    ...
    <div class="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                <h3 class="text-2xl font-serif font-bold mb-4">Logo</h3>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:opacity-80 transition-opacity">Book now</a></li>
                    <li><a href="#" class="hover:opacity-80 transition-opacity">View rooms</a></li>
                    <li><a href="#" class="hover:opacity-80 transition-opacity">See menu</a></li>
